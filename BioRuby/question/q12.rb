...
# 読み枠1の翻訳語を出力(塩基配列のi文字目から読み始める)
def pri(dna_hairetsu, i)
	aa_seq = codon_while(dna_hairetsu, i)
	aa_seq_str = aa_seq.join('')	#配列を仕切りなしでつなげる
	print(i + 1, '番塩基からの配列 = ', "\n")
	print(aa_seq_str, "\n")
end
### メインプログラム
...
pri(dna_hairetsu_1, 0)
pri(dna_hairetsu_1, 1)
pri(dna_hairetsu_1, 2)
#-----------------------------
# def codon_while
